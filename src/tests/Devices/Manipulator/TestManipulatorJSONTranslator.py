from bin.Dispatcher.Dictionary import ManipulatorKeysPC, ManipulatorKeysUC, ManipulatorDefaultValues
from bin.Devices.Manipulator import ManipulatorJSONTranslatorRPiToManipulator
import unittest
...
class TestRPiToManipulatorTranslator(unittest.TestCase):
    def setUp(self):
        ...
        self.expected_uc_dict = {
            ...
            ManipulatorKeysUC.GRIPPER_GRASPING[ManipulatorKeysUC.TOP_FINGER]:
                ManipulatorDefaultValues.GRIPPER_GRASPING[ManipulatorKeysUC.TOP_FINGER],
            ManipulatorKeysUC.GRIPPER_GRASPING[ManipulatorKeysUC.LEFT_FINGER]:
                ManipulatorDefaultValues.GRIPPER_GRASPING[ManipulatorKeysUC.LEFT_FINGER],
            ManipulatorKeysUC.GRIPPER_GRASPING[ManipulatorKeysUC.RIGHT_FINGER]:
                ManipulatorDefaultValues.GRIPPER_GRASPING[ManipulatorKeysUC.RIGHT_FINGER]
        }
